...
ffmpeg -i input.mp4 \
    -vf "scale=w=256:h=144" -c:v:0 libx264 -b:v:0 300k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 2 -hls_segment_filename "$FV/144p_part1_%03d.ts" -t 7 -hls_playlist_type vod "$FV/144p_part1.m3u8" \
    -vf "scale=w=426:h=240" -c:v:1 libx264 -b:v:1 500k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 2 -hls_segment_filename "$FV/240p_part1_%03d.ts" -t 7 -hls_playlist_type vod "$FV/240p_part1.m3u8" \
    -vf "scale=w=854:h=480" -c:v:2 libx264 -b:v:2 700k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 2 -hls_segment_filename "$FV/480p_part1_%03d.ts" -t 7 -hls_playlist_type vod "$FV/480p_part1.m3u8" \
    -vf "scale=w=1280:h=720" -c:v:3 libx264 -b:v:3 1000k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 2 -hls_segment_filename "$FV/720p_part1_%03d.ts" -t 7 -hls_playlist_type vod "$FV/720p_part1.m3u8"

ffmpeg -i input.mp4 \
    -vf "scale=w=256:h=144" -c:v:0 libx264 -b:v:0 500k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 6 -hls_segment_filename "$FV/144p_part2_%03d.ts" -ss 7 -hls_playlist_type vod $FV/144p_part2.m3u8 \
    -vf "scale=w=426:h=240" -c:v:1 libx264 -b:v:1 800k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 6 -hls_segment_filename "$FV/240p_part2_%03d.ts" -ss 7 -hls_playlist_type vod $FV/240p_part2.m3u8 \
    -vf "scale=w=854:h=480" -c:v:2 libx264 -b:v:2 1200k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 6 -hls_segment_filename "$FV/480p_part2_%03d.ts" -ss 7 -hls_playlist_type vod $FV/480p_part2.m3u8 \
    -vf "scale=w=1280:h=720" -c:v:3 libx264 -b:v:3 2500k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 6 -hls_segment_filename "$FV/720p_part2_%03d.ts" -ss 7 -hls_playlist_type vod $FV/720p_part2.m3u8

cat $FV/144p_part1.m3u8 $FV/144p_part2.m3u8 > $FV/144p.m3u8
cat $FV/240p_part1.m3u8 $FV/240p_part2.m3u8 > $FV/240p.m3u8
cat $FV/480p_part1.m3u8 $FV/480p_part2.m3u8 > $FV/480p.m3u8
cat $FV/720p_part1.m3u8 $FV/720p_part2.m3u8 > $FV/720p.m3u8
...
sed -i '3i#EXT-X-TARGETDURATION:6' $FV/144p.m3u8
...
sed -i '3i#EXT-X-TARGETDURATION:6' $FV/240p.m3u8
...
sed -i '3i#EXT-X-TARGETDURATION:6' $FV/480p.m3u8
...
sed -i '3i#EXT-X-TARGETDURATION:6' $FV/720p.m3u8
