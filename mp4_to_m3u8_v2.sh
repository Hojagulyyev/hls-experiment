...
ffmpeg -i input.mp4 \
    -vf "scale=w=256:h=144" -c:v:0 libx264 -b:v:0 300k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 3 -hls_segment_filename "$FV/144p_p1_%03d.ts" -t 7 -hls_playlist_type vod -an "$FV/144p_p1.m3u8" \
    -vf "scale=w=426:h=240" -c:v:1 libx264 -b:v:1 500k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 3 -hls_segment_filename "$FV/240p_p1_%03d.ts" -t 7 -hls_playlist_type vod -an "$FV/240p_p1.m3u8" \
    -vf "scale=w=854:h=480" -c:v:2 libx264 -b:v:2 700k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 3 -hls_segment_filename "$FV/480p_p1_%03d.ts" -t 7 -hls_playlist_type vod -an "$FV/480p_p1.m3u8" \
    -vf "scale=w=1280:h=720" -c:v:3 libx264 -b:v:3 1000k -g 72 -keyint_min 72 -sc_threshold 0 -hls_time 3 -hls_segment_filename "$FV/720p_p1_%03d.ts" -t 7 -hls_playlist_type vod -an "$FV/720p_p1.m3u8" \
    -map a:0 -c:a aac -b:a 128k -f hls -hls_time 3 -hls_segment_filename "$FV/audio_p1_%03d.aac" -t 7 "$FV/audio_p1.m3u8"

ffmpeg -i input.mp4 \
    -vf "scale=w=256:h=144" -c:v:0 libx264 -b:v:0 500k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 5 -hls_segment_filename "$FV/144p_p2_%03d.ts" -ss 7 -hls_playlist_type vod -an $FV/144p_p2.m3u8 \
    -vf "scale=w=426:h=240" -c:v:1 libx264 -b:v:1 800k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 5 -hls_segment_filename "$FV/240p_p2_%03d.ts" -ss 7 -hls_playlist_type vod -an $FV/240p_p2.m3u8 \
    -vf "scale=w=854:h=480" -c:v:2 libx264 -b:v:2 1200k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 5 -hls_segment_filename "$FV/480p_p2_%03d.ts" -ss 7 -hls_playlist_type vod -an $FV/480p_p2.m3u8 \
    -vf "scale=w=1280:h=720" -c:v:3 libx264 -b:v:3 2500k -g 144 -keyint_min 144 -sc_threshold 0 -hls_time 5 -hls_segment_filename "$FV/720p_p2_%03d.ts" -ss 7 -hls_playlist_type vod -an $FV/720p_p2.m3u8 \
    -map a:0 -c:a aac -b:a 128k -f hls -hls_time 5 -hls_segment_filename "$FV/audio_p2_%03d.aac" -ss 7 "$FV/audio_p2.m3u8"
...
cat $FV/audio_p1.m3u8 $FV/audio_p2.m3u8 > $FV/audio.m3u8
...
sed -i '/#EXTM3U/d' $FV/audio.m3u8
sed -i '/#EXT-X-VERSION/d' $FV/audio.m3u8
sed -i '/#EXT-X-TARGETDURATION/d' $FV/audio.m3u8
sed -i '/#EXT-X-MEDIA-SEQUENCE/d' $FV/audio.m3u8
sed -i '/#EXT-X-ENDLIST/d' $FV/audio.m3u8
...
sed -i '1i#EXTM3U' $FV/audio.m3u8
sed -i '2i#EXT-X-VERSION:3' $FV/audio.m3u8
sed -i '3i#EXT-X-TARGETDURATION:5' $FV/audio.m3u8
sed -i '4i#EXT-X-MEDIA-SEQUENCE:0' $FV/audio.m3u8
echo "#EXT-X-ENDLIST" >> $FV/audio.m3u8
...
echo "# Audio Group" >> $FV/index.m3u8
