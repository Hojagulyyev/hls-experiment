...
videos_dir="twitch_2p"

mkdir $videos_dir

ffmpeg -i input.mp4 \
    -vf "scale=w=256:h=144" -c:v:0 libx264 -preset veryfast -crf 23 -b:v:0 432k -g 73 -keyint_min 73 -sc_threshold 0 -hls_time 2 -t 10 \
        -hls_segment_filename "$videos_dir/144p_p1_%03d.ts" -hls_playlist_type vod -an "$videos_dir/144p_p1.m3u8" \
    -vf "scale=w=426:h=240" -c:v:1 libx264 -preset veryfast -crf 23 -b:v:1 720k -g 73 -keyint_min 73 -sc_threshold 0 -hls_time 2 -t 10 \
        -hls_segment_filename "$videos_dir/240p_p1_%03d.ts" -hls_playlist_type vod -an "$videos_dir/240p_p1.m3u8" \
    -vf "scale=w=854:h=480" -c:v:2 libx264 -preset veryfast -crf 23 -b:v:2 1440k -g 73 -keyint_min 73 -sc_threshold 0 -hls_time 2 -t 10 \
        -hls_segment_filename "$videos_dir/480p_p1_%03d.ts" -hls_playlist_type vod -an "$videos_dir/480p_p1.m3u8" \
    -vf "scale=w=1280:h=720" -c:v:3 libx264 -preset veryfast -crf 23 -b:v:3 2160k -g 73 -keyint_min 73 -sc_threshold 0 -hls_time 2 -t 10 \
        -hls_segment_filename "$videos_dir/720p_p1_%03d.ts" -hls_playlist_type vod -an "$videos_dir/720p_p1.m3u8" \
    -map a:0 -c:a aac -b:a 128k -f hls -hls_time 2 -t 10 \
        -hls_segment_filename "$videos_dir/audio_p1_%03d.aac" -hls_playlist_type vod "$videos_dir/audio_p1.m3u8"

ffmpeg -i input.mp4 \
    -vf "scale=w=256:h=144" -c:v:0 libx264 -preset veryfast -crf 23 -b:v:0 504k -g 120 -keyint_min 120 -sc_threshold 0 -hls_time 5 -ss 10 \
        -hls_segment_filename "$videos_dir/144p_p2_%03d.ts" -hls_playlist_type vod -an "$videos_dir/144p_p2.m3u8" \
    -vf "scale=w=426:h=240" -c:v:1 libx264 -preset veryfast -crf 23 -b:v:1 840k -g 120 -keyint_min 120 -sc_threshold 0 -hls_time 5 -ss 10 \
        -hls_segment_filename "$videos_dir/240p_p2_%03d.ts" -hls_playlist_type vod -an "$videos_dir/240p_p2.m3u8" \
    -vf "scale=w=854:h=480" -c:v:2 libx264 -preset veryfast -crf 23 -b:v:2 1680k -g 120 -keyint_min 120 -sc_threshold 0 -hls_time 5 -ss 10 \
        -hls_segment_filename "$videos_dir/480p_p2_%03d.ts" -hls_playlist_type vod -an "$videos_dir/480p_p2.m3u8" \
    -vf "scale=w=1280:h=720" -c:v:3 libx264 -preset veryfast -crf 23 -b:v:3 2520k -g 120 -keyint_min 120 -sc_threshold 0 -hls_time 5 -ss 10 \
        -hls_segment_filename "$videos_dir/720p_p2_%03d.ts" -hls_playlist_type vod -an "$videos_dir/720p_p2.m3u8" \
    -map a:0 -c:a aac -b:a 128k -f hls -hls_time 5 -ss 10 \
        -hls_segment_filename "$videos_dir/audio_p2_%03d.aac" -hls_playlist_type vod "$videos_dir/audio_p2.m3u8"
